...
namespace FinalProjectLibrary.Migrations
{
    ...
    [Migration("20251115150500_AddBookLanguage")]
            ...
            modelBuilder.Entity("FinalProjectLibrary.Models.History.StatusHistoryItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2025, 11, 14, 15, 4, 59, 869, DateTimeKind.Utc).AddTicks(3990)
                        },
                        new
                        {
                            ...
                            BookStatus = 2,
                            Notes = "Initial status",
                            Timestamp = new DateTime(2025, 11, 13, 15, 4, 59, 869, DateTimeKind.Utc).AddTicks(3994)
                        },
                        new
                        {
                            ...
                            BookStatus = 1,
                            Notes = "Initial status",
                            Timestamp = new DateTime(2025, 11, 12, 15, 4, 59, 869, DateTimeKind.Utc).AddTicks(3995)
                        });
                });
